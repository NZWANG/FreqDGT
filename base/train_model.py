...
def train(args, data_train, label_train, data_val, label_val, subject, trial):
    ...
    model.train = types.MethodType(safe_train, model)
    model.eval = types.MethodType(safe_eval, model)
